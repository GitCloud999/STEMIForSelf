...
public class CalculateLeadWiseSummary {

    public ArrayList<ArrayList<Double>> leadWiseCalculation(int[] rPeaks, double[] rrIntervals, int leadIdx, AllCalculatedData allData) {
...
//        System.out.println("Lead_"+(leadIdx+1)+"heartRate & BPM ==========" +heartRateFinal +"  ,  "+ bpmHeartRate);
        ...
        double prDurationMean = ut.findMeanInt(allData.duration.PR);
        ...
        double bpmPDurationStd = ut.calculateStdInt(allData.duration.P);
        ...
        double bpmPRDurationStd = ut.calculateStdInt(allData.duration.PR);
